...
class archi2(ThreeDScene):
    def construct(self):
        ...
        self.play(LaggedStart(Create(axes), Create(function), Create(area), Create(surface)), run_time = 12, lag_ratio = 0.5,)
